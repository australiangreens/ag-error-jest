...
exports.toBeValidAgErrorClassIndependentOfSourceName = void 0;
...
function toBeValidAgErrorClassIndependentOfSourceName(ReceivedClass) {
    if (this.isNot) {
    ...
    DummySubClass.errorName = 'NotTheSame';
    const dummyErr = new DummySubClass();
    pass = !this.equals(dummyErr.name, dummyErr.constructor.name);
    if (!pass)
        message += 'Expected instances of the class to have a name property/getter that is not reliant on the original class name (i.e works even if minified)';
    return {
        message: () => message,
        pass,
    };
}
exports.toBeValidAgErrorClassIndependentOfSourceName = toBeValidAgErrorClassIndependentOfSourceName;
//# sourceMappingURL=toBeValidAgErrorClassIndependentOfSourceName.js.map